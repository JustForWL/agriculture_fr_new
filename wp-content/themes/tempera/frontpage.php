	...
	<div class="scrollcon">
		...
		<div class="Cont" id="ISL_Cont">
			<div class="ScrCont">
				<div id="List1">
					<!-- 图片列表 begin -->
					<div class="pic"><a title="" href="#"><img width="265" height="200" alt="" src="images/picture7.png"  /></a></div> 
					<div class="pic"><a title="" href="#"><img width="265" height="200" alt="" src="images/picture8.png" /></a></div>
					<div class="pic"><a title="" href="#"><img width="265" height="200" alt="" src="images/picture10.png"></a></div>
					<div class="pic"><a title="" href="#"><img width="265" height="200" alt="" src="images/picture7.png"  /></a></div> 
					<div class="pic"><a title="" href="#"><img width="265" height="200" alt="" src="images/picture8.png" /></a></div>
					<div class="pic"><a title="" href="#"><img width="265" height="200" alt="" src="images/picture9.png"></a></div> 
					<div class="pic"><a title="" href="#"><img width="265" height="200" alt="" src="images/picture10.png"></a></div>
					<div class="pic"><a title="" href="#"><img width="265" height="200" alt="" src="images/picture7.png"  /></a></div> 
					<div class="pic"><a title="" href="#"><img width="265" height="200" alt="" src="images/picture8.png" /></a></div>
					<div class="pic"><a title="" href="#"><img width="265" height="200" alt="" src="images/picture9.png"></a></div> 
...
<div align="center"><a href="#"><img src="images/picture11.png"/></a></div>
</div>
...
<div class="b1">
	...
	<div style="float:right;height:300px;"><div style="padding-left:10px;margin-top:10px;"><img src="images/picture19.png" /></div>
		...
		<ul style="list-style:none;height:85px;margin-left:10px;margin-top:5px;">
			<li style="display:inline;margin:3px;"><img src="images/picture20.png" height="80px;width:80px;"/></li>
			<li style="display:inline;margin:3px;"><img src="images/picture20.png" height="80px;width:80px;"/></li>
			<li style="display:inline;margin:3px;"><img src="images/picture20.png" height="80px;width:80px;"/></li>
			<li style="display:inline;margin:3px;"><img src="images/picture20.png" height="80px;width:80px;"/></li>
		...
		<div style="margin-left:10px;margin-top:20px;"><a href="#"><img src="images/picture21.png" /></a></div>
	</div>
</div>
</div> <!-- #pp-afterslider -->
</div> <!-- #frontpage -->
