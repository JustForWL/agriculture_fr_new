...
<div class="lianxi1">
	<img src="images/picture32.png">
        <form id="reg" method="post" action="regSuccess" name="form1">
          ...
          <input type="radio" value="1" name="job" checked="checked"><font color="#666666">首席执行官/主席</font><div style="width:118px;display:inline-block;"></div><input type="radio" value="2" name="job"><font color="#666666">市场经理</font><br />
