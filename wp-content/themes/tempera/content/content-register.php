...
<div class="lianxi1">
	<img src="images/picture32.png">
        <form id="reg" method="post" action="" name="form1">
          ...
          <input type="radio" value="1" name="hangye"><font color="#CFCFCF">独立代理</font><br />
          <input type="radio" value="2" name="hangye"><font color="#CFCFCF">进口商、分销商</font><br />
          <input type="radio" value="3" name="hangye"><font color="#CFCFCF">超市</font><br />
          <input type="radio" value="4" name="hangye"><font color="#CFCFCF">餐饮行业</font><br />
          <input type="radio" value="5" name="hangye"><font color="#CFCFCF">媒体</font><br />
          <input type="radio" value="6" name="hangye"><font color="#CFCFCF">爱好者</font><br />
          <input type="hidden" name="hangye2" />
          <input type="radio"  onclick="getFromOther('other1');" name="hangye" value="7" ><font color="#CFCFCF">其它&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font><input type="text" id="other1" size="40" readonly="readonly" name="other1" onchange="sendContent('other1')"><br />
          </div>
          <div style="height:10px;"></div>
          <div style="width:450px;height:0px;border-top:1px #ccc dashed;" />
          <div style="height:15px;"></div>
          ...
          <input type="radio" value="1" name="scale" /><font color="#CFCFCF">1-20人</font><div style="width:120px;display:inline-block;">&nbsp;</div><input type="radio" value="4" name="scale" /><font color="#CFCFCF">100-250人</font><br />
          <input type="radio" value="2" name="scale" /><font color="#CFCFCF">20-50人</font><div style="width:113px;display:inline-block;">&nbsp;</div><input type="radio" value="5" name="scale" /><font color="#CFCFCF">250-400人</font><br />
          <input type="radio" value="3" name="scale" /><font color="#CFCFCF">50-100人</font><div style="width:105px;display:inline-block;">&nbsp;</div><input type="radio" value="6" name="scale" /><font color="#CFCFCF">400人以上</font><br />
          <div style="height:15px;"></div>
          ...
          <input type="radio" value="1" name="job"><font color="#CFCFCF">首席执行官/主席</font><div style="width:120px;display:inline-block;">&nbsp;</div><input type="radio" value="2" name="job"><font color="#CFCFCF">市场经理</font><br />
          <input type="radio" value="3" name="job"><font color="#CFCFCF">总经理</font><div style="width:180px;display:inline-block;">&nbsp;</div><input type="radio" value="4" name="job"><font color="#CFCFCF">销售</font><br />
          <input type="radio" value="5" name="job"><font color="#CFCFCF">品牌经理</font><div style="width:165px;display:inline-block;">&nbsp;</div><input type="radio" value="6" name="job"><font color="#CFCFCF">采购</font><br />
          <input type="radio" value="7" name="job"><font color="#CFCFCF">产品经理</font><div style="width:165px;display:inline-block;">&nbsp;</div><input type="radio" value="8" name="job"><font color="#CFCFCF">编辑</font><br />
          <input type="radio" value="9" name="job"><font color="#CFCFCF">销售经理</font><div style="width:165px;display:inline-block;">&nbsp;</div><input type="radio" value="10" name="job"><font color="#CFCFCF">记者</font><br />
          <input type="hidden" name="job2">
          <input type="radio"  onclick="getFromOther('other2');" name="job" value="11"><font color="#CFCFCF">其它&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font><input type="text" id="other2" size="36" readonly="readonly" onchange="sendContent('other2')"><br />
          <div style="height:15px;"></div>
