...
function tempera_set_social_icons($idd) {
	...
	echo '<a  target="_blank" rel="nofollow" href="#" class="socialicons social-YouTube" title="微信"><img alt="微信" src="http://localhost/agriculture_fr/wp-content/themes/tempera/images/socials/tengxunweibo.png"/></a>';
