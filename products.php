...
<div style="padding-left:10%;padding-top:5%;">
                      ...
                      <table width="100%" border="0" align="center" cellpadding="none" cellspacing="none" frame="void">
                        <tbody>
                        <tr>
                        	<td colspan="2" height="60px;"><img src="images/discover/picture1.png"></td>
                        </tr>
                          <tr>
                            <td><img src="images/discover/1-fsd.jpg" alt="" width="220" height="450" usemap="#Map11"/></td>
                            <td><img src="images/discover/2_FSG.jpg" alt="" width="220" height="450" usemap="#Map12"/></td>
                            <td><img src="images/discover/3_ffv.jpg" alt="" width="220" height="450" usemap="#Map13"/></td>
                            <td><img src="images/discover/4_fsg.jpg" alt="" width="220" height="450" usemap="#Map41"/></td>
                          </tr>
                          <tr>
                            <td><img src="images/discover/5-fdp.jpg" alt="" width="220" height="450" usemap="#Map16"/>
                              <map name="Map16">
                                <area shape="rect" coords="60,398,160,424" href="#">
                            </map></td>
                            <td><img src="images/discover/6-fcp.jpg" alt="" width="220" height="450" usemap="#Map15"/></td>
                            <td><img src="images/discover/7_fdp.jpg" alt="" width="221" height="450" usemap="#Map17"/></td>
                            <td><img src="images/discover/8-fws.jpg" alt="" width="220" height="450" usemap="#Map18"/></td>
                          </tr>
                          <tr>
                            <td><img src="images/discover/9_fmm.jpg" alt="" width="220" height="450" usemap="#Map19"/>
                              <map name="Map19">
                                <area shape="rect" coords="59,396,161,424" href="#">
                            </map></td>
                            <td><img src="images/discover/10-fs.jpg" alt="" width="220" height="450" usemap="#Map20"/></td>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                          </tr>
                        </tbody>
...
<map name="Map12">
  <area shape="rect" coords="61,397,164,424" href="#">
</map>


<map name="Map14">
  <area shape="rect" coords="62,397,162,424" href="#">
</map>

<map name="Map15">
  <area shape="rect" coords="62,398,164,424" href="#">
</map>
<map name="Map17">
  <area shape="rect" coords="61,398,162,424" href="#">
</map>
...
<map name="Map20">
  <area shape="rect" coords="60,396,160,424" href="#">
</map>

<map name="Map11">
  <area shape="rect" coords="65,399,164,425" href="#">
</map>

<map name="Map13">
  <area shape="rect" coords="61,397,162,424" href="#">
</map>
</div> <!-- #pp-afterslider -->
</div> <!-- #frontpage -->
