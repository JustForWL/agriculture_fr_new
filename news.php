...
<link rel="alternate" type="application/rss+xml" title=" &raquo; 璇勮Feed" href="http://localhost/agriculture_fr/comments/feed" />
...
<div align="center" valign="middle" style="display:inline;height:39px;line-height:39px;" onMouseOver="showmenu(event, other)" onMouseOut="delayhidemenu()"><img src="images/picture22.png" /><font color="#7F7F7F">中文</font>
</div>
...
<div class="headersearch" style="width:auto;display:inline-block;clear:none;padding:5px 0px 8px 0;float:right; margin-right:200px; margin-top:0px;position:relative;"> 
...
</form>&nbsp;&nbsp;&nbsp;&nbsp;<div class="socials" id="sheader"><a  target="_blank" rel="nofollow" href="#" class="socialicons social-YouTube" title="鏂版氮寰崥"><img alt="鏂版氮寰崥" src="wp-content/themes/tempera/images/socials/xinlangweibo.png"/></a><a  target="_blank" rel="nofollow" href="#" class="socialicons social-YouTube" title="鑵捐寰崥"><img alt="鑵捐寰崥" src="wp-content/themes/tempera/images/socials/tengxunweibo.png"/></a></div></div>

</div>

<div id="header-full" style="height:70px;">
	<img src="images/p2.jpg" usemap="#map" border="0" style="margin-top:0px;;"  />
	<map name="map">
	<area shape="rect" coords="780, 25, 840, 53" href="#" target="_black" alt="首页" title="首页" />
	<area shape="rect" coords="850, 25, 940, 53" href="#" target="_black" alt="发现法国产品" title="发现法国产品" />
	<area shape="rect" coords="970, 25, 1049, 53" href="#" target="_black" alt="寻找法国公司" title="寻找法国公司" />
	<area shape="rect" coords="1085, 25, 1112, 53" href="#" target="_black" alt="新闻" title="新闻" />
	</map>
</div><!-- #header-full -->
...
<div id="pp-afterslider" style="height:800px;">
<div style="padding-left:10%;padding-top:5%;">
	<div>
        <img src="images/picture60.png" style="display:inline;">
        <div class="headersearch" style="width:auto;display:inline-block;clear:none;padding:5px 0px 8px 0;float:right; margin-right:50%; margin-top:0px;position:relative;"> 
            <form method="get" id="searchform"
            action="http://localhost/agriculture_fr//">
            <input type="text" value="搜索新闻"
            name="s" id="s"
            onblur="if (this.value == '')
            {this.value = '搜索新闻';}"
            onfocus="if (this.value == '搜索新闻')
            {this.value = '';}" />
            <input type="submit" id="searchsubmit" value="&#xe816;" />
            </form>
        </div>
        <table border="0" cellspacing="0" cellpadding="0" style="display:inline;margin-left:60%;margin-top:-100px;"><tr><td style="vertical-align:top;border-right-style:solid; border-right-width:1px; border-right-color:#999"width="55px" height="14px;"><img id="news" onClick="askContent('news');" src="images/picture61_1.png" height="14px;"></td><td width="15px" style="vertical-align:top;"></td><td style="vertical-align:top;border-right-style:solid; border-right-width:1px; border-right-color:#999"width="55px" height="14px;"><img id="talk" onClick="askContent('talk');" src="images/picture62_2.png" height="14px;"></td><td width="15px" style="vertical-align:top;"></td><td style="vertical-align:top;"width="60px" height="14px;"><img id="shijian" onClick="askContent('shijian');" src="images/picture63_2.png" height="14px;"></td></tr></table>
     </div>
     <table style="margin-top:60px;" width="100%">
     	<tr>
        <td style="vertical-align:top; border-bottom-width:2px; border-bottom-style:dashed;" height="230px">
        	<img src="images/picture3.png" style="display:inline;" width="200" height="174"/><div style="margin-left:250px;margin-top:-175px; height:200px;" ><h1><font color="#FF0000">缓慢食品、 功能性食品、 快速休闲和共同烹饪 — — 食品发展趋势综述</font></h1><p>缓慢食品、 功能性食品、 快速休闲和共同烹饪 — — 食品发展趋势综述<br/>缓慢食品、 功能性食品、 快速休闲和共同烹饪 — — 食品发展趋势综述<br/>缓慢食品、 功能性食品、 快速休闲和共同烹饪 — — 食品发展趋势综述<br/>缓慢食品、 功能性食品、 快速休闲和共同烹饪 — — 食品发展趋势综述<br/>缓慢食品、 功能性食品、 快速休闲和共同烹饪 — — 食品发展趋势综述<br/>缓慢食品、 功能性食品、 快速休闲和共同烹饪 — — 食品发展趋势综述<br/>......</p><a href="#"><img src="images/picture64.png" style="display:inline;"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/picture65.png" border="0" usemap="#Map4" hidefocus="true" ></div>
        </td>
        </tr>
        <tr>
        	<td height="20px;"></td>
...
<map name="Map4">
  ...
  <area shape="circle" coords="13,12,12" href="#" alt="新浪微博" title="新浪微博" />
  <area shape="circle" coords="47,14,12" href="#" alt="腾讯微博" title="腾讯微博" />
</map>
